...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/phillips_results_search \
  -H 'Content-Type: application/json' \
  -d '{"artist":"Banksy","limit":5}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/phillips_results_search`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
